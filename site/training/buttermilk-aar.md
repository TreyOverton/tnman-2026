...
- **NCOIC role-name confusion (training vs. scenario).** With no pre-training coordination, 1SG Snow had a nominal moment of confusion between his **scenario role** (Situation Unit Leader inside the fictional Operation BUTTERMILK ICP — a role 1SG Snow was visibly assigned in the [Command Roster](ics-forms-participant.md#command-roster) by name and rank) and his **real role** (NCOIC of the training session itself). The two collided because the participant page lists "1SG Wendell L. Reece" as Situation Unit Leader for BUTTERMILK — and 1SG Snow understandably read his own name into that line. Fix: at the moment of the tablet handoff, the OIC should explicitly say *"You're the training NCOIC. The scenario roster is for the participants to inhabit — you stay you."* Trainer Notes updated to include that line in the [pre-training NCOIC orientation](ics-forms-trainer.md#pre-training-during-oics-planning-window).
...
- **Participant Q (follow-on):** *"Can't we have something where all the timestamps are automatic and we can type the notes?"* OIC answer: That's the goal — see Recommendation #1 (digital ICS 214). Caveat: we still need a paper-and-pen path for power-out / no-network scenarios. Direct validation, from a Soldier in the seat, of the digital-214 ask in the [Commander's Brief](buttermilk-cdr-brief.md#forward-asks-60s--the-what-do-you-need-from-me-slot).
- **2LT Aaron E. Garrison (3 BN S4) — 214 turn-in feedback:**
  ...
  - **Improve:** *"Could include official FEMA instructions; hammer home purpose of each document."* Two distinct asks: (1) link/include the canonical FEMA ICS form library so participants can pull authoritative templates after the session — actionable for the next iteration of the [Participant Notes](ics-forms-participant.md); (2) "hammer home purpose" reinforces the design intent behind the [bookend "What is this form for?" prefix/suffix](ics-forms-trainer.md#brief-back-questions-by-form) added mid-session — purpose really is the lesson worth teaching, and a participant landed on the same conclusion independently.
