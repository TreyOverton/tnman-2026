...
```mermaid
timeline
    title TNMAN 26 — 3 RGT Exercise Execution
    section 13 MAY (D+0 · ADVON)
        0519 BMNT : ICP / RSA assembly NLT
        0800-1400 : ICP established within 6 hrs of notification
        1400-1800 : SECFOR initial patrols stand-up · Daily COMMEX
        2031 EENT : Close-out day · demob to home
    section 14 MAY (D+1 · MAIN DAY)
        0519 BMNT : Personnel back on site
        0800 : Full SECFOR posture · sUAS detection runs
        0900-1200 : OPFOR probes · base-entrance inject · waterway inject
        1200-1600 : Cyber TTX window (distributed) · drone-approval inject
        1600-2000 : Scenario ENDEX prep · recovery
        2131 EENT : Phase II ENDEX NLT
    section 15 MAY (D+2 · AAR)
        0700-1200 : Half-day wrap · comms-blackout PACE exercise (scenario)
        1200-1600 : Local AAR · hot wash · equipment recovery
        NLT 2131 : Phase III initial actions complete
```
...
```mermaid
gantt
    title TNMAN 26 — 14 MAY 26 (D+1 Main Day) Parallel Activities
    dateFormat  HH:mm
    axisFormat  %H:%M

    section ICP C2
    Battle rhythm open            :icp1, 05:19, 01:40
    Intent brief                  :icp2, after icp1, 02:00
    SITMAP / CCIR cycle           :icp3, after icp2, 05:30
    Stand-down + ENDEX prep       :icp4, after icp3, 04:00
    ENDEX & demob                 :milestone, icp5, 21:31, 0m

    section SECFOR
    Morning muster + ROE brief    :sec1, 06:00, 01:00
    Full patrol rotation (12)     :sec2, 07:00, 10:00
    Screen forward (3)            :sec3, 07:00, 10:00
    QRF on tether (2)             :sec4, 07:00, 10:00
    Patrol recovery               :sec5, 17:00, 04:31

    section UAS / Air
    Pre-flight                    :uas1, 05:30, 01:30
    Sortie 1 (NAI 3003/3004)      :uas2, 07:00, 02:00
    Sortie 2 (NAI 3007)           :uas3, 09:00, 01:30
    Sortie 3 (NAI 3006/3009)      :uas4, 12:00, 01:30
    Sortie 4 (NAI 3008/3009)      :uas5, 13:30, 01:30
    Stand-down + LiPo SOP         :uas6, 17:00, 02:00

    section Comms
    Daily HF/TACN COMMEX          :com1, 07:00, 02:00
    Real-time reporting           :com2, 09:00, 08:00
    Cyber TTX SA window           :com3, 12:00, 01:30
    PACE close-out                :com4, 19:00, 02:31

    section Exercise Control
    OPFOR probe #1 (NAI 3002)     :inj1, 07:00, 01:00
    Drone-approval test           :inj2, 09:00, 01:30
    Base-entrance inject          :inj3, 10:30, 01:30
    ORNL cyber scenario (DIV G6)  :inj4, 12:00, 01:30
    Waterway inject (NAI 3007)    :inj5, 13:30, 01:30
    OPFOR climactic probe         :inj6, 15:00, 02:00
    ENDEX                         :milestone, inj7, 21:31, 0m
```
