...
![TNMAN 26 Area of Operations — satellite view centered on Holston Army Ammunition Plant, Kingsport TN. Holston River wraps around the southern and eastern edges of the facility; I-81 / Kingsport commercial corridor is visible at the top.](/docs/source/TNMAN-AoO-Satellite.png ':size=100%')

*[Full-resolution source image](/docs/source/TNMAN-AoO-Satellite.png)*
...
- Severe thunderstorm squall line late 9–10 MAY with damaging winds and power outages
...
- **Title 10 / SAD command authority seam (L-1)** — H initial / M residual pending JAG consultation
- **Medical readiness (M-1 through M-4)** — all at L residual under the binary-control framework (deploy with deviation or do not deploy)
