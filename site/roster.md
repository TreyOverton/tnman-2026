...
Personnel slated for TNMAN 2026. Current as of LTC Sheaf's **29 APR 26 email** *("These are my current expectations.")*. Draft — names will continue to adjust as planning matures.

> **Download (xlsx):** [3 RGT Mission Roster — TNMAN 26 (29 APR)](/docs/source/Mission-Roster-TNMAN-26-29APR.xlsx) — Sheaf's 29 APR workbook (Summary · HHC · 2 BN · 3 BN · 4 BN). Prior 22 APR workbook with strikethroughs preserved at [Mission-Roster-TNMAN-26.xlsx](/docs/source/Mission-Roster-TNMAN-26.xlsx).
>
...
| Unit | Count | <span class="mrc mrc-1">MRC-1</span> | <span class="mrc mrc-2">MRC-2</span> | <span class="mrc mrc-3">MRC-3</span> | <span class="mrc mrc-4">MRC-4</span> | Unknown |
|------|------:|------:|------:|------:|------:|------:|
...
|------|------|----------|-----|--------------|
| COL | Roark, Robert R | RGT CO | <span class="mrc mrc-2">MRC-2</span> | 423-329-2620<br>robert.roark@tnstateguard.org<br>1503 Hazel Dr, Greeneville, TN 37745 |
| LTC | Smith, Joseph S (Scott) | XO | <span class="mrc mrc-1">MRC-1</span> | 423-306-1509<br>scott.smith@tnstateguard.org<br>4911 Carters Valley Rd, Church Hill, TN 37642 |
...
| CPT | McCroskey, Travis D | ASST JAG · JAG / Legal Officer (Command Staff) — **remote on-call 13-14 MAY only** | <span class="mrc mrc-4">MRC-4</span> | 865-696-0164<br>travis.mccroskey@tnstateguard.org<br>1123 Stewart St, Knoxville, TN 37917<br>*Phone call w/ 1LT Overton, 3 MAY 26: not physically attending; available remotely for JAG questions on 13-14 MAY. Not occupying ICP physical billet — see [JAG / Legal Officer guide](/participant-guides/jag.md).* |
...
| 1SG | Snow, Michael E | S2 NCO | <span class="mrc mrc-1">MRC-1</span> | 423-773-1063<br>michael.snow@tnstateguard.org<br>102 Mountain View Cir, Hampton, TN 37658 |
| SFC | Bradley, Timothy W | Rec NCO | <span class="mrc mrc-1">MRC-1</span> | 423-579-9649<br>timothy.bradley@tnstateguard.org<br>273 Lester Rd, Blountville, TN 37617 |
...
| Rank | Name | Position | MRC | Contact Info |
|------|------|----------|-----|--------------|
| CPT | Borrilez, Michael S | BN CO | <span class="mrc mrc-2">MRC-2</span> | 916-220-0262<br>michael.borrilez@tnstateguard.org<br>770 Lower Paint Creek Rd, Greeneville, TN 37743 |
...
*Per LTC Sheaf 29 APR 26: SFC Ferguson and 1LT Riley are back on the roster (reversal of the 22 APR text-message removal). 2LT Steele dropped from the working roster. **PV1 Elrod (son of PV2 Charles Elrod) was added 29 APR but removed 30 APR** — per voice conversation between LTC Sheaf and 1LT Overton, PV1 Elrod is not yet sworn in, has not attended IET, and has not had a PHA, which disqualifies him under DIV OPORD §3.j.(11).(d).*
...
| 1LT | Riley, Michael W | BN XO · FAA Part 107 UAS Pilot | <span class="mrc mrc-4">unknown</span> | 423-291-0365<br>michael.riley@tnstateguard.org<br>214 Arrowhead Private Dr, Mountain City, TN 37683 |
| SFC | Ferguson, Joshua | HQ Co 1SG | <span class="mrc mrc-4">unknown</span> | 423-278-8869<br>joshua.ferguson@tnstateguard.org<br>240 Plates Ln, Greeneville, TN 37745 |
...
*CPT Widner has confirmed this list to be those that have expressed willingness to participate.*
...
| MAJ | Bennett, Richard A | Chaplain | <span class="mrc mrc-4">MRC-4</span> | 336-428-6994<br>richard.bennett@tnstateguard.org<br>124 Rillwood Ln, Maryville, TN 37801<br>*4 MAY 26 — 1LT Fielitz-Scarbrough (S1) confirms MAJ Bennett officially returned from IRR to active duty. Prior IRR status was not reflected in the roster (he had appeared as active throughout); the IRR-to-active transition explains the MRC-4 status — no PHA was possible while IRR. PHA path now opens; MRC re-verification becomes feasible.* |
...
| SSG | Whalen, John R | A Co 1SG (Acting) | <span class="mrc mrc-1">MRC-1</span> | 865-358-0094<br>john.whalen@tnstateguard.org<br>114 Romo Rd, Harriman, TN 37748 |
| SSG | Miles, Matthew E | MP Sqd Ldr | <span class="mrc mrc-3">MRC-3</span> | 518-256-2400<br>matthew.miles@tnstateguard.org<br>116 Shenandoah Dr, Seymour, TN 37865 |
...
- **DIV-tracked PAX (was 31 organic)** — Estes 26 APR DIV-CG email referenced 31; Sheaf's 29 APR roster brought organic to 31. After PV1 Elrod removal 30 APR organic dropped to 30; after **SGT Ian M. Overton restoration 2 MAY** organic is back to **31**. After **CPT McCroskey clarification 3 MAY** (remote on-call only, not physically attending), **physical-on-ground organic = 30**; CPT McCroskey remains on the manifest as a remote JAG asset for 13-14 MAY. Attached **61st MED Co medics (3, of which MAJ Markus F. Gampe named per ICS-203)** are still expected on top of organic. **Plus SFC Acosta (SDFF, IRR) on the ICS-203 as Pilot 3.** Working target physically on the ground: **~34 PAX** (30 organic on-ground + 3 medics + Acosta), with **CPT McCroskey remote on-call** for legal questions. *Source: [Comms Log 26 APR](comms.md), [29 APR](comms.md), [30 APR](comms.md), [2 MAY](comms.md), [3 MAY](comms.md).*
...
- **MRC-4 (unknown) personnel** — verifications still required for: **Bennett, Neisler, Hendon** (all 4 BN). **MAJ Bennett**: 4 MAY 26 — 1LT Fielitz-Scarbrough (S1) confirms officially returned from IRR to active duty; the IRR status (not previously reflected in our roster) explains the MRC-4 standing (no PHA was possible while IRR), and the PHA path is now open. **CPT McCroskey** is also MRC-4, but the verification is no longer a deployment blocker for him — per 3 MAY clarification he is remote on-call only, not physically attending. MRC-unknown verifications pending for **1LT Riley, SFC Ferguson** (3 BN — restored 29 APR, MRC field blank in Sheaf's 29 APR xlsx). Per DD-2977 v2 / BG Cox 1 MAY guidance, all of these (when physically on-site) default to MRC-3 controlled-environment treatment with individual deployment plans (DD 2977 Block 4) rather than blocking on verification. PV1 Elrod removed 30 APR.
