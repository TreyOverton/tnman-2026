...
|------|------:|------:|------:|------:|------:|
| Regimental HQ | 10 | 5 | 5 | 0 | 0 |
| 2nd Battalion | 3 | 2 | 1 | 0 | 0 |
| 3rd Battalion | 8 | 4 | 1 | 2 | 1 |
| 4th Battalion | 7 | 2 | 1 | 1 | 3 |
| **Total (draft)** | **28** | **13** | **8** | **3** | **4** |
...
| 2LT | Steele, Michael M | B Co | <span class="mrc mrc-1">MRC-1</span> | 276-477-3104<br>michael.steele@tnstateguard.org<br>210 Arrowhead Pvt Dr, Mountain City, TN 37683 |
...
- **DIV-tracked PAX = 31** (LTC Estes 26 APR DIV-CG email; BG Cox 25 APR AAR also references 31). Reconciles to **28 organic + 3 attached 61st MED Co medics** (per [CG Intent](docs/cg-intent.md)). Confirms the medics are being counted at DIV level; names/MRC still TBD per BG Cox's 61st MED BN follow-up. *Source: [Comms Log 26 APR](comms.md).*
- **Not attending TNMAN-26 (23 APR strikethrough in Sheaf's xlsx)** — 10 additional personnel struck by LTC Sheaf in the 23 APR reply to the mission roster workbook. PAX drops 38 → **28**. All removed from the unit tables above but remain in the [Chain of Command](coc.md) (if they held a CoC billet). Removals:
  - **HHC (1)** — CPT McCroskey (ASST JAG). Impact: **no organic JAG** on the mission. Routes to COL Williams (PMO) per DIV OPORD already.
  - **2 BN (5 of 8)** — 1LT Barnes (Chaplain), SSG Lillard (Comm NCO), SGT Spence (Info Tech), SGT Walker (ASST S3 NCO), CPL Cate (S3 Clerk). Remaining 2 BN: BN CO / BN XO / HQ Co 1SG only.
  - **3 BN (3)** — CPT Moore (S6 C&E Officer), SGT Overton, Ian M (A Co MP), PV1 Gauthier (A Co MP). Impact: thins 3 BN comms; A Co MP team drops from 4 → 2.
  - **4 BN (1)** — **LT Hoskins** (Part 107 UAS Pilot, fixed-wing). Impact: Part 107 pilot pool drops **3 → 1** (CPT Widner sole remaining organic pilot; Riley out, Hoskins out). RFF gap deepens.
- **MRC-4 (unknown) personnel** — after 23 APR removals, still-unverified MRC-4 are: Bennett, Neisler, Hendon (all 4 BN). McCroskey, Walker, Moore, Gauthier are no longer applicable (not attending).
